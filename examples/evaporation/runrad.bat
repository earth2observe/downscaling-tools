...
rem start python ..\..\e2o_dstools\e2o_radiation.py -S 81 -E 160 -D highResDEM\wflow_dem.map -d lowResDEM\dem.tif -O output_rad_linke -s 5 -e 22 -T180 -l DEBUG -L ../../data/linke
